...
namespace Ocelot.GrpcHttpGateway
{
    public class GrpcClient : ClientBase<GrpcClient>
    {
        ...
        {
            return await InvokeMethodAsync(method, message, GetDefaultCallOptions(), null);

            //object[] obj = { method, message, callOptions };
            //string name = "InvokeAsync";
            //Type[] parameterType = { typeof(MethodDescriptor), typeof(string),typeof(CallOptions) };
        ...
        static object InvokeMethod(GrpcClient grpcClient, MethodDescriptor method, Type[] parameterType, string name, params object[] args)
        {
        ...
        [Obsolete("暂不使用")]
        static object InvokeMethod(Type clsType, object classInstance, Type[] templateTypeSet, Type[] parameterType, string name, params object[] args)
        {
            MethodInfo methodInfo = clsType.GetMethod(name, parameterType);
            methodInfo = methodInfo.MakeGenericMethod(templateTypeSet);
            return methodInfo.Invoke(classInstance, args);
        }
        /// <summary>
        /// 不转task了
        /// </summary>
        static object InvokeMethodAsync(Type clsType, object classInstance, Type[] templateTypeSet, Type[] parameterType, string name, params object[] args)
        {
