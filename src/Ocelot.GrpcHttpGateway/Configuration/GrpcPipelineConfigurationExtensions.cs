...
{
    public static class GrpcPipelineConfigurationExtensions
    {
        ...
        /// </summary>
        private static Func<DownstreamContext, bool> AddOrleansHttpGateway(this IOcelotPipelineBuilder builder, OcelotPipelineConfiguration pipelineConfiguration)
        {
